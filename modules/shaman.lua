...
if config.enabled and addon.playerClass == "SHAMAN" then	
	...
	addon:AddReminder("Missing Shield", function() return not addon:PlayerHasAnyAura(config.shields) end, {type = "spell", spell1 = config.shields[1], spell2 = config.shields[2]})
