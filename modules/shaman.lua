...
if config.enabled and addon.playerClass == "SHAMAN" then	
	...
	local mainHandAttributes = {type = "spell", slot = 16, spell1 = config.mainHandEnchants[1], spell2 = config.mainHandEnchants[2], threshold = config.thresholdTime}
	local offHandAttributes = {type = "spell", slot = 17, spell1 = config.offHandEnchants[1], spell2 = config.offHandEnchants[2], threshold = config.thresholdTime}
